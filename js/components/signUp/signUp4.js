...
class SignUp4 extends Component {
    ...
    onSubmit() {
        ...
        this.pushNewRoute('signUpApprove', {signObj: signObj});
        return;
                            ...
                            <View style={styles.signupContainer}>
                                ...
                                <View>
                                    ...
                                    <View style={{height: 40}}>
                                        <Text style={[styles.infoText, {opacity: 1, fontSize: 18}]}>Son bir adım kaldı!</Text>
                                    </View>

                                    <View style={{height: 50, marginBottom: 60, paddingLeft: 20, paddingRight: 20}}>
                                        <Text style={styles.infoText}>Girmiş olduğun bilgiler X app’te şifreli şekilde saklanacaktir ve müşterisi olduğun bankadan doğrulanacaktir.</Text>
                                    </View>

                                    <View style={{height: 40}}>
                                        <Button rounded
                                                onPress={() => { this.onSubmit(); }}
                                                style={styles.sonAdimBtn}
                                ...
                                <View style={bkmThemeCommon.signUpBtnContainer}>
                                    <Button rounded
...
export default connect(null, bindAction)(SignUp4);
